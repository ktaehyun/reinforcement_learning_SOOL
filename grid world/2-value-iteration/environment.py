...
class GraphicDisplay(tk.Tk):
    ...
    def load_images(self):
        PhotoImage = ImageTk.PhotoImage
        up = PhotoImage(Image.open("C:/Users/ktaehyun/Desktop/취준/대내외활동/SOOL/grid world/2-value-iteration/img/up.png").resize((13, 13)))
        right = PhotoImage(Image.open("C:/Users/ktaehyun/Desktop/취준/대내외활동/SOOL/grid world/2-value-iteration/img/right.png").resize((13, 13)))
        left = PhotoImage(Image.open("C:/Users/ktaehyun/Desktop/취준/대내외활동/SOOL/grid world/2-value-iteration/img/left.png").resize((13, 13)))
        down = PhotoImage(Image.open("C:/Users/ktaehyun/Desktop/취준/대내외활동/SOOL/grid world/2-value-iteration/img/down.png").resize((13, 13)))
        rectangle = PhotoImage(
            Image.open("C:/Users/ktaehyun/Desktop/취준/대내외활동/SOOL/grid world/2-value-iteration/img/rectangle.png").resize((65, 65)))
        triangle = PhotoImage(
            Image.open("C:/Users/ktaehyun/Desktop/취준/대내외활동/SOOL/grid world/2-value-iteration/img/triangle.png").resize((65, 65)))
        circle = PhotoImage(Image.open("C:/Users/ktaehyun/Desktop/취준/대내외활동/SOOL/grid world/2-value-iteration/img/circle.png").resize((65, 65)))
